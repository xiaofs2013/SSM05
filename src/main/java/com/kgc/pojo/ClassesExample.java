...
public class ClassesExample {
     ...
     * @author hewei
     */
    public ClassesExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public ClassesExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public ClassesExample page(Integer page, Integer pageSize) {
